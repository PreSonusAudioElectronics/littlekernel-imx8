...
/*!
 * @brief XTAL 26M clock frequency.
 */
#define OSC26M_CLK_FREQ 26000000U
/*!
...
typedef enum _clock_ip_name
{
    ...
    kCLOCK_Ocotp = CCM_TUPLE(34U, 33U), /*!< OCOTP Clock Gate.*/
...
typedef uintptr_t clock_root_control_t;

#define kCLOCK_RootM7       ((uintptr_t)(&(CCM)->ROOT[1].TARGET_ROOT))  /*!< ARM Cortex-M7 Clock control name.*/
#define kCLOCK_RootAxi      ((uintptr_t)(&(CCM)->ROOT[16].TARGET_ROOT)) /*!< AXI Clock control name.*/
#define kCLOCK_RootNoc      ((uintptr_t)(&(CCM)->ROOT[26].TARGET_ROOT)) /*!< NOC Clock control name.*/
#define kCLOCK_RootAhb      ((uintptr_t)(&(CCM)->ROOT[32].TARGET_ROOT)) /*!< AHB Clock control name.*/
#define kCLOCK_RootIpg      ((uintptr_t)(&(CCM)->ROOT[33].TARGET_ROOT)) /*!< IPG Clock control name.*/
#define kCLOCK_RootAudioAhb ((uintptr_t)(&(CCM)->ROOT[34].TARGET_ROOT)) /*!< Audio AHB Clock control name.*/
#define kCLOCK_RootAudioIpg ((uintptr_t)(&(CCM)->ROOT[35].TARGET_ROOT)) /*!< Audio IPG Clock control name.*/
#define kCLOCK_RootDramAlt  ((uintptr_t)(&(CCM)->ROOT[64].TARGET_ROOT)) /*!< DRAM ALT Clock control name.*/

#define kCLOCK_RootSai2 ((uintptr_t)(&(CCM)->ROOT[76].TARGET_ROOT))  /*!< SAI2 Clock control name.*/
#define kCLOCK_RootSai3 ((uintptr_t)(&(CCM)->ROOT[77].TARGET_ROOT))  /*!< SAI3 Clock control name.*/
#define kCLOCK_RootSai5 ((uintptr_t)(&(CCM)->ROOT[79].TARGET_ROOT))  /*!< SAI5 Clock control name.*/
#define kCLOCK_RootSai6 ((uintptr_t)(&(CCM)->ROOT[80].TARGET_ROOT))  /*!< SAI6 Clock control name.*/
#define kCLOCK_RootSai7 ((uintptr_t)(&(CCM)->ROOT[134].TARGET_ROOT)) /*!< SAI7 Clock control name.*/
#define kCLOCK_RootSpdif1 ((uintptr_t)(&(CCM)->ROOT[81].TARGET_ROOT))  /*!< SPDIF1 Clock control name.*/
#define kCLOCK_RootSpdif2 ((uintptr_t)(&(CCM)->ROOT[82].TARGET_ROOT))  /*!< SPDIF2 Clock control name.*/

#define kCLOCK_RootQspi ((uintptr_t)(&(CCM)->ROOT[87].TARGET_ROOT)) /*!< QSPI Clock control name.*/

#define kCLOCK_RootI2c1 ((uintptr_t)(&(CCM)->ROOT[90].TARGET_ROOT)) /*!< I2C1 Clock control name.*/
#define kCLOCK_RootI2c2 ((uintptr_t)(&(CCM)->ROOT[91].TARGET_ROOT)) /*!< I2C2 Clock control name.*/
#define kCLOCK_RootI2c3 ((uintptr_t)(&(CCM)->ROOT[92].TARGET_ROOT)) /*!< I2C3 Clock control name.*/
#define kCLOCK_RootI2c4 ((uintptr_t)(&(CCM)->ROOT[93].TARGET_ROOT)) /*!< I2C4 Clock control name.*/

#define kCLOCK_RootUart1 ((uintptr_t)(&(CCM)->ROOT[94].TARGET_ROOT)) /*!< UART1 Clock control name.*/
#define kCLOCK_RootUart2 ((uintptr_t)(&(CCM)->ROOT[95].TARGET_ROOT)) /*!< UART2 Clock control name.*/
#define kCLOCK_RootUart3 ((uintptr_t)(&(CCM)->ROOT[96].TARGET_ROOT)) /*!< UART3 Clock control name.*/
#define kCLOCK_RootUart4 ((uintptr_t)(&(CCM)->ROOT[97].TARGET_ROOT)) /*!< UART4 Clock control name.*/

#define kCLOCK_RootEcspi1 ((uintptr_t)(&(CCM)->ROOT[101].TARGET_ROOT)) /*!< ECSPI1 Clock control name.*/
#define kCLOCK_RootEcspi2 ((uintptr_t)(&(CCM)->ROOT[102].TARGET_ROOT)) /*!< ECSPI2 Clock control name.*/
#define kCLOCK_RootEcspi3 ((uintptr_t)(&(CCM)->ROOT[131].TARGET_ROOT)) /*!< ECSPI3 Clock control name.*/

#define kCLOCK_RootPwm1 ((uintptr_t)(&(CCM)->ROOT[103].TARGET_ROOT)) /*!< PWM1 Clock control name.*/
#define kCLOCK_RootPwm2 ((uintptr_t)(&(CCM)->ROOT[104].TARGET_ROOT)) /*!< PWM2 Clock control name.*/
#define kCLOCK_RootPwm3 ((uintptr_t)(&(CCM)->ROOT[105].TARGET_ROOT)) /*!< PWM3 Clock control name.*/
#define kCLOCK_RootPwm4 ((uintptr_t)(&(CCM)->ROOT[106].TARGET_ROOT)) /*!< PWM4 Clock control name.*/

#define kCLOCK_RootGpt1 ((uintptr_t)(&(CCM)->ROOT[107].TARGET_ROOT)) /*!< GPT1 Clock control name.*/
#define kCLOCK_RootGpt2 ((uintptr_t)(&(CCM)->ROOT[108].TARGET_ROOT)) /*!< GPT2 Clock control name.*/
#define kCLOCK_RootGpt3 ((uintptr_t)(&(CCM)->ROOT[109].TARGET_ROOT)) /*!< GPT3 Clock control name.*/
#define kCLOCK_RootGpt4 ((uintptr_t)(&(CCM)->ROOT[110].TARGET_ROOT)) /*!< GPT4 Clock control name.*/
#define kCLOCK_RootGpt5 ((uintptr_t)(&(CCM)->ROOT[111].TARGET_ROOT)) /*!< GPT5 Clock control name.*/
#define kCLOCK_RootGpt6 ((uintptr_t)(&(CCM)->ROOT[112].TARGET_ROOT)) /*!< GPT6 Clock control name.*/
...
static inline uintptr_t get_kCLOCK_Root_by_index(unsigned idx)
{
    ...
    return ((uintptr_t)(&(CCM)->ROOT[idx].TARGET_ROOT));
}
...
#define kCLOCK_ArmPllGate ((uintptr_t)(&(CCM)->PLL_CTRL[12].PLL_CTRL)) /*!< ARM PLL Gate.*/

#define kCLOCK_GpuPllGate  ((uintptr_t)(&(CCM)->PLL_CTRL[13].PLL_CTRL)) /*!< GPU PLL Gate.*/
#define kCLOCK_VpuPllGate  ((uintptr_t)(&(CCM)->PLL_CTRL[14].PLL_CTRL)) /*!< VPU PLL Gate.*/
#define kCLOCK_DramPllGate ((uintptr_t)(&(CCM)->PLL_CTRL[15].PLL_CTRL)) /*!< DRAM PLL1 Gate.*/

#define kCLOCK_SysPll1Gate      ((uintptr_t)(&(CCM)->PLL_CTRL[16].PLL_CTRL)) /*!< SYSTEM PLL1 Gate.*/
#define kCLOCK_SysPll1Div2Gate  ((uintptr_t)(&(CCM)->PLL_CTRL[17].PLL_CTRL)) /*!< SYSTEM PLL1 Div2 Gate.*/
#define kCLOCK_SysPll1Div3Gate  ((uintptr_t)(&(CCM)->PLL_CTRL[18].PLL_CTRL)) /*!< SYSTEM PLL1 Div3 Gate.*/
#define kCLOCK_SysPll1Div4Gate  ((uintptr_t)(&(CCM)->PLL_CTRL[19].PLL_CTRL)) /*!< SYSTEM PLL1 Div4 Gate.*/
#define kCLOCK_SysPll1Div5Gate  ((uintptr_t)(&(CCM)->PLL_CTRL[20].PLL_CTRL)) /*!< SYSTEM PLL1 Div5 Gate.*/
#define kCLOCK_SysPll1Div6Gate  ((uintptr_t)(&(CCM)->PLL_CTRL[21].PLL_CTRL)) /*!< SYSTEM PLL1 Div6 Gate.*/
#define kCLOCK_SysPll1Div8Gate  ((uintptr_t)(&(CCM)->PLL_CTRL[22].PLL_CTRL)) /*!< SYSTEM PLL1 Div8 Gate.*/
#define kCLOCK_SysPll1Div10Gate ((uintptr_t)(&(CCM)->PLL_CTRL[23].PLL_CTRL)) /*!< SYSTEM PLL1 Div10 Gate.*/
#define kCLOCK_SysPll1Div20Gate ((uintptr_t)(&(CCM)->PLL_CTRL[24].PLL_CTRL)) /*!< SYSTEM PLL1 Div20 Gate.*/

#define kCLOCK_SysPll2Gate      ((uintptr_t)(&(CCM)->PLL_CTRL[25].PLL_CTRL)) /*!< SYSTEM PLL2 Gate.*/
#define kCLOCK_SysPll2Div2Gate  ((uintptr_t)(&(CCM)->PLL_CTRL[26].PLL_CTRL)) /*!< SYSTEM PLL2 Div2 Gate.*/
#define kCLOCK_SysPll2Div3Gate  ((uintptr_t)(&(CCM)->PLL_CTRL[27].PLL_CTRL)) /*!< SYSTEM PLL2 Div3 Gate.*/
#define kCLOCK_SysPll2Div4Gate  ((uintptr_t)(&(CCM)->PLL_CTRL[28].PLL_CTRL)) /*!< SYSTEM PLL2 Div4 Gate.*/
#define kCLOCK_SysPll2Div5Gate  ((uintptr_t)(&(CCM)->PLL_CTRL[29].PLL_CTRL)) /*!< SYSTEM PLL2 Div5 Gate.*/
#define kCLOCK_SysPll2Div6Gate  ((uintptr_t)(&(CCM)->PLL_CTRL[30].PLL_CTRL)) /*!< SYSTEM PLL2 Div6 Gate.*/
#define kCLOCK_SysPll2Div8Gate  ((uintptr_t)(&(CCM)->PLL_CTRL[31].PLL_CTRL)) /*!< SYSTEM PLL2 Div8 Gate.*/
#define kCLOCK_SysPll2Div10Gate ((uintptr_t)(&(CCM)->PLL_CTRL[32].PLL_CTRL)) /*!< SYSTEM PLL2 Div10 Gate.*/
#define kCLOCK_SysPll2Div20Gate ((uintptr_t)(&(CCM)->PLL_CTRL[33].PLL_CTRL)) /*!< SYSTEM PLL2 Div20 Gate.*/

#define kCLOCK_SysPll3Gate ((uintptr_t)(&(CCM)->PLL_CTRL[34].PLL_CTRL)) /*!< SYSTEM PLL3 Gate.*/

#define kCLOCK_AudioPll1Gate ((uintptr_t)(&(CCM)->PLL_CTRL[35].PLL_CTRL)) /*!< AUDIO PLL1 Gate.*/
#define kCLOCK_AudioPll2Gate ((uintptr_t)(&(CCM)->PLL_CTRL[36].PLL_CTRL)) /*!< AUDIO PLL2 Gate.*/
#define kCLOCK_VideoPll1Gate ((uintptr_t)(&(CCM)->PLL_CTRL[37].PLL_CTRL)) /*!< VIDEO PLL1 Gate.*/
#define kCLOCK_VideoPll2Gate ((uintptr_t)(&(CCM)->PLL_CTRL[38].PLL_CTRL)) /*!< VIDEO PLL2 Gate.*/
...
uint32_t CLOCK_ComputeFracPllFreq(uint32_t refClkFreq, uint32_t m, uint8_t p, uint8_t s, int16_t dsm);
/*!
 * @brief Adjust analog frac pll frequency.
 *
 * @param type fractional pll type.
 * @param ppb adjustement requested.
 *
 * @return  Clock frequency
 */
...
/*!
 * @brief Get the CCM SAI bus frequency.
 * @param sai_root defined in clock_root_control_t
 *
 * @return  Clock frequency; If the clock is invalid, returns 0.
 */
